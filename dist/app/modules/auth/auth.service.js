...
const loginUser = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const isUserExist = yield user_model_1.UserModel.isUserExistByPhone(phoneNumber);
    if (!isUserExist) {
    ...
    const accessToken = jwt_helpers_1.jwtHelpers.createToken({ id: UserId, role }, config_1.default.jwt.secret, config_1.default.jwt.expires_in);
    const refreshToken = jwt_helpers_1.jwtHelpers.createToken({ id: UserId, role }, config_1.default.jwt.refresh_secret, config_1.default.jwt.refresh_expires_in);
